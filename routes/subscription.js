...
router.post('/', function(req, res, next) {
    ...
    db.query(insertquery,[req.body.customer_id, req.body.category_id, req.body.subscribedate, req.body.unsubscribedate],
    (err, result) => {
         if (err) {
             console.log(err);
             res.render('error');
...
router.get('/:recordid/edit', function(req, res, next) {
    let query = "SELECT subscription_id, customer_id, category_id, subscribedate, unsubscribedate FROM subscription WHERE subscription_id = " 
    + req.params.recordid;
